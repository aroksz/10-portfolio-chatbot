# Section 10: Portfolio Chatbot

**Level:** Capstone  
**Goal:** Add a safe, rule-based assistant that answers questions about a student portfolio.  
**Coding ideas:** Text matching, objects, functions, message rendering, safe fallback design
...
2. Open the folder named `10-portfolio-chatbot`.
...
1. Create a new public GitHub repository named `10-portfolio-chatbot`.
...
`https://YOUR-USERNAME.github.io/10-portfolio-chatbot/`
